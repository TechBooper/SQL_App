...
sentry_dsn = os.getenv("SENTRY_DSN")  # Removed default value
...
try:
    if sentry_dsn:
        sentry_sdk.init(
            ...
            debug=environment
            != "production",  # Enable debug mode in non-production environments
            ...
            ),  # Lower trace rate in production
        ...
        print("Sentry DSN not provided. Continuing without Sentry.")
