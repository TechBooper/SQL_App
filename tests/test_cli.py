...
class TestCLI(unittest.TestCase):
    def setUp(self):
        ...
        self.test_session = {"username": "test_user", "role": "Management"}
    ...
    def test_menu_navigation_view_profile(self):
        ...
        with patch("cli.User.get_by_username", return_value=mock_user), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_update_email(self):
        ...
        with patch("cli.User.get_by_username", return_value=mock_user), patch(
            "cli.prompt_input", return_value=new_email
    ...
    def test_update_email_invalid_format(self):
        ...
        with patch("cli.User.get_by_username", return_value=mock_user), patch(
            "cli.prompt_input", side_effect=[invalid_email, valid_email]
        ), patch("builtins.print") as mock_print:
    ...
    def test_update_email_user_not_found(self):
        ...
        with patch("cli.User.get_by_username", return_value=None), patch(
            "cli.prompt_input", return_value="new@example.com"
        ), patch("builtins.print") as mock_print:
    ...
    def test_manage_users_permission_denied(self):
        ...
        with patch("cli.has_permission", return_value=False), patch(
            "cli.has_any_user_management_permission", return_value=False
        ), patch("builtins.print") as mock_print:
    ...
    def test_manage_clients_view_clients(self):
        test_session = {"username": "test_user", "role": "Management"}
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.get_all_clients", return_value=mock_clients
    ...
    def test_manage_contracts_create_contract_success(self):
        test_session = {"username": "test_user", "role": "Commercial"}
        ...
        with patch("cli.prompt_input", side_effect=mock_inputs), patch(
            "cli.create_contract", return_value="Contract created successfully"
    ...
    def test_manage_events_assign_support_success(self):
        ...
        # Mock input values
        mock_inputs = ["1", "support_user"]  # event_id  # support_user_username

        with patch("cli.prompt_input", side_effect=mock_inputs), patch(
            "cli.assign_support_to_event",
            return_value="Support user assigned successfully",
        ) as mock_assign, patch("builtins.print") as mock_print:

            handle_assign_support(test_session)

            # Adjusted user_id to username per previous changes
            mock_assign.assert_called_once_with(
                username="test_user", event_id=1, support_user_id="support_user"
            )
    ...
    def test_manage_events_filter_unassigned(self):
        ...
        with patch("cli.filter_events_unassigned", return_value=mock_events), patch(
            "cli.display_events"
        ) as mock_display:
    ...
    def test_menu_navigation_invalid_choice(self):
        ...
        with patch("cli.build_main_menu_options", return_value=mock_options), patch(
            "cli.display_main_menu"
        ) as mock_display_menu, patch(
            "cli.prompt_choice", side_effect=mock_responses
        ), patch(
            "cli.has_permission", return_value=True
        ), patch(
            "cli.has_any_user_management_permission", return_value=True
        ), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_handle_delete_client_cancelled(self):
        ...
        with patch("cli.prompt_input", return_value="client@test.com"), patch(
    ...
    def test_create_user_password_mismatch(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.prompt_input",
            side_effect=["new_user", "new@example.com", "Management"],
        ), patch("cli.getpass.getpass", side_effect=["password1", "password2"]), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_update_user_not_found(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.prompt_input",
            side_effect=["old_user", "new_user", "new@example.com", "Management"],
        ), patch("cli.getpass.getpass", side_effect=["", ""]), patch(
            "cli.update_user", return_value="User not found"
        ), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_delete_user_confirm_no(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.prompt_input", return_value="some_user"
        ), patch("cli.confirm_action", return_value=False), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_view_users_none_found(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.get_all_users", return_value=[]
    ...
    def test_manage_clients_no_permissions(self):
        ...
        test_session_no_perm = {"username": "test_user", "role": "UnknownRole"}
        with patch("cli.has_permission", return_value=False), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_view_clients_no_data(self):
        # No clients found
        with patch("cli.has_permission", return_value=True), patch(
            "cli.get_all_clients", return_value=[]
        ), patch("cli.display_clients") as mock_display:
    ...
    def test_update_client_no_such_client(self):
        ...
        ), patch("cli.update_client", return_value="Client not found"), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_delete_client_not_found(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.prompt_input", return_value="notfound@example.com"
        ), patch("cli.confirm_action", return_value=True), patch(
            "cli.delete_client", return_value="Client not found"
        ), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_view_contracts_no_permissions(self):
        ...
        test_session_no_perm = {"username": "no_perm_user", "role": "UnknownRole"}
        with patch("cli.has_permission", return_value=False), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_view_contracts_empty(self):
        # No contracts found
        with patch("cli.has_permission", return_value=True), patch(
            "cli.get_all_contracts", return_value=[]
    ...
    def test_update_contract_invalid_input(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.prompt_input", side_effect=["abc", "notfloat", "notfloat", "1"]
        ), patch("builtins.print") as mock_print:
            handle_update_contract(self.test_session)
            mock_print.assert_called_with(
                "Invalid input. Please enter valid numbers for ID and amounts.\n"
            )

    def test_delete_contract_invalid_id(self):
        # Invalid contract ID
        with patch("cli.has_permission", return_value=True), patch(
            "cli.prompt_input", return_value="notint"
        ), patch("cli.confirm_action", return_value=True), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_filter_contracts_invalid_selection(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.prompt_input", return_value="3"
        ), patch("builtins.print") as mock_print:
    ...
    def test_manage_events_no_permission(self):
        no_perm_session = {"username": "no_perm_user", "role": "UnknownRole"}
        with patch("cli.has_permission", return_value=False), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_create_event_invalid_input(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            ...
            mock_print.assert_called_with(
                "Invalid input. Please enter valid numbers for IDs and attendees.\n"
            )
    ...
    def test_update_event_not_found(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.prompt_input",
            side_effect=["9999", "2024-01-01", "2024-01-02", "Paris", "100", "Notes"],
        ), patch("cli.update_event", return_value="Event not found"), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_delete_event_not_found(self):
        ...
        with patch("cli.has_permission", return_value=True), patch(
            "cli.prompt_input", return_value="9999"
        ), patch("cli.confirm_action", return_value=True), patch(
            "cli.delete_event", return_value="Event not found"
        ), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_filter_events_unassigned_none(self):
        ...
        with patch("cli.filter_events_unassigned", return_value=[]), patch(
            "cli.display_events"
        ) as mock_display:
    ...
    def test_filter_events_assigned_to_me_none(self):
        ...
        support_session = {"username": "support_user", "role": "Support"}
        with patch("cli.filter_events_by_support_user", return_value=[]), patch(
            "cli.display_events"
        ) as mock_display:
    ...
    def test_interactive_session_logout_immediately(self):
        ...
        with patch("cli.build_main_menu_options", return_value=mock_options), patch(
            "cli.display_main_menu"
        ), patch("cli.prompt_choice", return_value="1"), patch(
            "builtins.print"
        ) as mock_print:
    ...
    def test_interactive_session_invalid_selection_twice(self):
        ...
        with patch("cli.build_main_menu_options", return_value=mock_options), patch(
            "cli.display_main_menu"
        ), patch("cli.prompt_choice", side_effect=["999", "998", "2"]), patch(
            "builtins.print"
        ) as mock_print:
            interactive_session(self.test_session)
