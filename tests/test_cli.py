...
class TestCLI(unittest.TestCase):
    ...
    def test_menu_navigation_view_profile(self):
        ...
        with patch('main.cli.User.get_by_username', return_value=mock_user), \
    ...
    def test_update_email(self):
        ...
        with patch('main.cli.User.get_by_username', return_value=mock_user), \
             patch('main.cli.prompt_input', return_value=new_email), \
             patch('builtins.print') as mock_print:
    ...
    def test_update_email_invalid_format(self):
        ...
        with patch('main.cli.User.get_by_username', return_value=mock_user), \
             patch('main.cli.prompt_input', side_effect=[invalid_email, valid_email]), \
             patch('builtins.print') as mock_print:
    ...
    def test_update_email_user_not_found(self):
        ...
        with patch('main.cli.User.get_by_username', return_value=None), \
             patch('main.cli.prompt_input', return_value='new@example.com'), \
             patch('builtins.print') as mock_print:
    ...
    def test_manage_users_permission_denied(self):
        ...
        with patch('main.cli.has_permission', return_value=False), \
            patch('main.cli.has_any_user_management_permission', return_value=False), \
            patch('builtins.print') as mock_print:
    ...
    def test_manage_clients_view_clients(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
            patch('main.cli.get_all_clients', return_value=mock_clients), \
            patch('main.cli.display_clients') as mock_display:
    ...
    def test_manage_contracts_create_contract_success(self):
        ...
        with patch('main.cli.prompt_input', side_effect=mock_inputs), \
            patch('main.cli.create_contract', return_value='Contract created successfully') as mock_create, \
            patch('builtins.print') as mock_print:
    ...
    def test_manage_events_assign_support_success(self):
        ...
        with patch('main.cli.prompt_input', side_effect=mock_inputs), \
            patch('main.cli.assign_support_to_event', return_value='Support user assigned successfully') as mock_assign, \
            patch('builtins.print') as mock_print:
    ...
    def test_manage_events_filter_unassigned(self):
        ...
        with patch('main.cli.filter_events_unassigned', return_value=mock_events), \
            patch('main.cli.display_events') as mock_display:
    ...
    def test_menu_navigation_invalid_choice(self):
        ...
        with patch('main.cli.build_main_menu_options', return_value=mock_options), \
             patch('main.cli.display_main_menu') as mock_display_menu, \
             patch('main.cli.prompt_choice', side_effect=mock_responses), \
             patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.has_any_user_management_permission', return_value=True), \
             patch('builtins.print') as mock_print:
    ...
    def test_handle_delete_client_cancelled(self):
        ...
        with patch('main.cli.prompt_input', return_value='client@test.com'), \
            patch('main.cli.confirm_action', return_value=False), \
            patch('builtins.print') as mock_print:
    ...
    def test_create_user_password_mismatch(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', side_effect=["new_user", "new@example.com", "Management"]), \
             patch('main.cli.getpass.getpass', side_effect=["password1", "password2"]), \
             patch('builtins.print') as mock_print:
    ...
    def test_update_user_not_found(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', side_effect=["old_user", "new_user", "new@example.com", "Management"]), \
             patch('main.cli.getpass.getpass', side_effect=["", ""]), \
             patch('main.cli.update_user', return_value='User not found'), \
             patch('builtins.print') as mock_print:
    ...
    def test_delete_user_confirm_no(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', return_value="some_user"), \
             patch('main.cli.confirm_action', return_value=False), \
             patch('builtins.print') as mock_print:
    ...
    def test_view_users_none_found(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.get_all_users', return_value=[]), \
             patch('main.cli.display_users') as mock_display:
    ...
    def test_view_clients_no_data(self):
        # No clients found
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.get_all_clients', return_value=[]), \
             patch('main.cli.display_clients') as mock_display:
    ...
    def test_update_client_no_such_client(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', side_effect=["notfound@example.com", "John", "Doe", "new@example.com", "1234567890", "NewCo"]), \
             patch('main.cli.update_client', return_value='Client not found'), \
             patch('builtins.print') as mock_print:
    ...
    def test_delete_client_not_found(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', return_value="notfound@example.com"), \
             patch('main.cli.confirm_action', return_value=True), \
             patch('main.cli.delete_client', return_value='Client not found'), \
             patch('builtins.print') as mock_print:
    ...
    def test_view_contracts_empty(self):
        # No contracts found
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.get_all_contracts', return_value=[]), \
             patch('main.cli.display_contracts') as mock_display:
    ...
    def test_update_contract_invalid_input(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', side_effect=["abc", "notfloat", "notfloat", "1"] ), \
             patch('builtins.print') as mock_print:
    ...
    def test_delete_contract_invalid_id(self):
        # Invalid contract ID
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', return_value="notint"), \
             patch('main.cli.confirm_action', return_value=True), \
             patch('builtins.print') as mock_print:
    ...
    def test_filter_contracts_invalid_selection(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', return_value="3"), \
             patch('builtins.print') as mock_print:
    ...
    def test_create_event_invalid_input(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', side_effect=["notint", "2024-01-01", "2024-01-02", "Paris", "notint", "Notes"]), \
             patch('builtins.print') as mock_print:
    ...
    def test_update_event_not_found(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', side_effect=["9999", "2024-01-01", "2024-01-02", "Paris", "100", "Notes"]), \
             patch('main.cli.update_event', return_value='Event not found'), \
             patch('builtins.print') as mock_print:
    ...
    def test_delete_event_not_found(self):
        ...
        with patch('main.cli.has_permission', return_value=True), \
             patch('main.cli.prompt_input', return_value="9999"), \
             patch('main.cli.confirm_action', return_value=True), \
             patch('main.cli.delete_event', return_value='Event not found'), \
             patch('builtins.print') as mock_print:
    ...
    def test_filter_events_unassigned_none(self):
        ...
        with patch('main.cli.filter_events_unassigned', return_value=[]), \
             patch('main.cli.display_events') as mock_display:
    ...
    def test_filter_events_assigned_to_me_none(self):
        ...
        with patch('main.cli.filter_events_by_support_user', return_value=[]), \
             patch('main.cli.display_events') as mock_display:
    ...
    def test_interactive_session_logout_immediately(self):
        ...
        with patch('main.cli.build_main_menu_options', return_value=mock_options), \
             patch('main.cli.display_main_menu'), \
             patch('main.cli.prompt_choice', return_value='1'), \
             patch('builtins.print') as mock_print:
    ...
    def test_interactive_session_invalid_selection_twice(self):
        ...
        with patch('main.cli.build_main_menu_options', return_value=mock_options), \
             patch('main.cli.display_main_menu'), \
             patch('main.cli.prompt_choice', side_effect=['999', '998', '2']), \
             patch('builtins.print') as mock_print:
            interactive_session(self.test_session)
